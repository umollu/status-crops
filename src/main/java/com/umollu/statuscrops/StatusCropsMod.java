...
public class StatusCropsMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        STATUSCROP_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(MOD_ID, "statuscrop"), BlockEntityType.Builder.create(StatusCropBlockEntity::new, STATUSCROP).build(null));
